        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Organizers_ContactInformations_ContactInformationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sponsors_ContactInformations_ContactInformationId",
                        column: x => x.ContactInformationId,
                        principalTable: "ContactInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Participants_ContactInformations_ContactInformationId",
                        column: x => x.ContactInformationId,
                        principalTable: "ContactInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organizers_ContactInformationId",
                table: "Organizers",
                column: "ContactInformationId");

            migrationBuilder.CreateIndex(
                name: "IX_Participants_ContactInformationId",
                table: "Participants",
                column: "ContactInformationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Speakers_ContactInformationId",
                table: "Speakers",
                column: "ContactInformationId");
